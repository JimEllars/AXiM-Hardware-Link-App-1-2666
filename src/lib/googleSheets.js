...
export async function getAccessToken() {
  ...
  try {
    ...
    console.error("Google Sheets Auth Error: Failed to fetch access token.", error);
    throw error;
  }
}
...
export const appendRows = (range, rows) => sheetsRequest(`/values/${encodeURIComponent(range)}:append?valueInputOption=USER_ENTERED&insertDataOption=INSERT_ROWS`, {
  method: 'POST',
